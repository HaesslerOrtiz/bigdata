...
\section{Metodología}
Este informe se desarrolla conforme a lo establecido en el \texttt{Assignment \#3}, aunque con algunas variaciones 
...
\begin{enumerate}
   \item \textbf{Exploración y análisis de datos}
    ...
    \item \textbf{Limpieza y preprocesamiento de datos}
    \begin{itemize}
